...
export type * as WasiSocketsInstanceNetwork029 from './interfaces/wasi-sockets-instance-network.js'; // import wasi:sockets/instance-network@0.2.9
export type * as WasiSocketsIpNameLookup029 from './interfaces/wasi-sockets-ip-name-lookup.js'; // import wasi:sockets/ip-name-lookup@0.2.9
export type * as WasiSocketsNetwork029 from './interfaces/wasi-sockets-network.js'; // import wasi:sockets/network@0.2.9
export type * as WasiSocketsTcpCreateSocket029 from './interfaces/wasi-sockets-tcp-create-socket.js'; // import wasi:sockets/tcp-create-socket@0.2.9
export type * as WasiSocketsTcp029 from './interfaces/wasi-sockets-tcp.js'; // import wasi:sockets/tcp@0.2.9
export type * as WasiSocketsUdpCreateSocket029 from './interfaces/wasi-sockets-udp-create-socket.js'; // import wasi:sockets/udp-create-socket@0.2.9
export type * as WasiSocketsUdp029 from './interfaces/wasi-sockets-udp.js'; // import wasi:sockets/udp@0.2.9
