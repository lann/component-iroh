...
pub(crate) struct Conn {
    ...
    #[cfg(wasm_wasi)]
    #[debug("DatagramPipe")]
    pub(crate) conn: super::datagram_pipe::DatagramPipe,
...
impl Conn {
    ...
    pub(crate) async fn new(
        #[cfg(all(not(wasm_browser), not(wasm_wasi)))] io: tokio_websockets::WebSocketStream<
            MaybeTlsStream<ProxyStream>,
        >,
        #[cfg(wasm_browser)] io: ws_stream_wasm::WsStream,
        #[cfg(wasm_wasi)] io: super::datagram_pipe::DatagramPipe,
        key_cache: KeyCache,
